...
# Conteúdo mínimo para um output.xml válido, caso precise ser criado
CONTEUDO_MINIMO_XML = """<?xml version="1.0" encoding="UTF-8"?>
<robot generator="manual" generated="20250101T000000">
  <suite name="EmptySuite">
  </suite>
</robot>
"""
...
# --- FUNÇÃO PRINCIPAL (com as alterações) ---
...
def main():
    ...
    # --- Obtenção das Configurações do Ambiente (.env) ---
    ...
    # Converte a string de tags em uma lista, removendo espaços em branco
